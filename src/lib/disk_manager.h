 ...
 * key, falling back to each progressive path if a value is not found.
 * Additionally, the function takes a fallback key in case the file being read
 * exists, but the first key is not present or set.
 *
